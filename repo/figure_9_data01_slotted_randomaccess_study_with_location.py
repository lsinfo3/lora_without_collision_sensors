...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep 12 08:57:32 2021
...
np.save('all_syncs_array_no_recovery_location', all_syncs_array)
np.save('all_synclosses_array_no_recovery_location', all_synclosses_array)
np.save('all_crosstraffic_collisions_array_no_recovery_location', all_crosstraffic_collisions_array)
np.save('all_systematic_collisions_array_array_no_recovery_location', all_systematic_collisions_array)
np.save('all_slotted_collisions_array_no_recovery_location', all_slotted_collisions_array)
np.save('all_collisions_array_no_recovery_location', all_collisions_array)
