...
for i in range(len(ppm_drift)):
    ...
    for l in range(len(percent_crosstraffic)):
        ...
        possible_slots = np.linspace(0,3600,all_messages)   
...
np.save('all_syncs_array_lesstraffic_sameslots_no_recovery', all_syncs_array)
np.save('all_synclosses_array_lesstraffic_sameslots_no_recovery', all_synclosses_array)
np.save('all_crosstraffic_collisions_array_lesstraffic_sameslots_no_recovery', all_crosstraffic_collisions_array)
np.save('all_systematic_collisions_array_array_lesstraffic_sameslots_no_recovery', all_systematic_collisions_array)
np.save('all_slotted_collisions_array_lesstraffic_sameslots_no_recovery', all_slotted_collisions_array)
np.save('all_collisions_array_lesstraffic_sameslots_no_recovery', all_collisions_array)
