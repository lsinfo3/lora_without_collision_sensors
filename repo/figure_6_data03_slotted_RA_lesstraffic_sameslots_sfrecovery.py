...
np.save('all_syncs_array_lesstraffic_sameslots_sfrecovery', all_syncs_array)
np.save('all_synclosses_array_lesstraffic_sameslots_sfrecovery', all_synclosses_array)
np.save('all_crosstraffic_collisions_array_lesstraffic_sameslots_sfrecovery', all_crosstraffic_collisions_array)
np.save('all_systematic_collisions_array_array_lesstraffic_sameslots_sfrecovery', all_systematic_collisions_array)
np.save('all_slotted_collisions_array_lesstraffic_sameslots_sfrecovery', all_slotted_collisions_array)
np.save('all_collisions_array_lesstraffic_sameslots_sfrecovery', all_collisions_array)
