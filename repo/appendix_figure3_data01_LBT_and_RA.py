...
np.save('ra_lbt_percent_backshift_total', percent_backshift)
np.save('ra_lbt_percent_sensors_backshift', percent_sensors_backshift)
np.save('ra_lbt_percent_allcollisions', percent_allcollisions)
np.save('ra_lbt_percent_RA_collisions', percent_RA_collisions)
np.save('ra_lbt_percent_lbt_collisions', percent_lbt_collisions)
np.save('ra_lbt_avg_backshift_time', avg_backshift_time)
